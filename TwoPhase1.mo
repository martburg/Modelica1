package TwoPhase1
  package Examples
    ...
    model Base_TwoPhaseExample_Var1_Energy
      ...
      Modelica.Fluid.Valves.ValveLinear valveLinear1(redeclare package Medium = StandardWater, port_a_T.start = 293.15, port_b_T.start = 293.15, dp_nominal = 1000, m_flow_nominal = 1) annotation(Placement(visible = true, transformation(origin = {25, -30}, extent = {{-10, -10}, {10, 10}}, rotation = -270)));
      ...
      Modelica.Blocks.Sources.Ramp ramp1(duration = 200, offset = 5, height = 0, startTime = 100) annotation(Placement(visible = true, transformation(origin = {-65, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Sources.Ramp ramp2(offset = 0, startTime = 500, height = 1e5, duration = 500) annotation(Placement(visible = true, transformation(origin = {-65, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ...
      Components.TwoPhaseVerticalPipe_Var1 P_1(D = 0.1, redeclare replaceable model PhaseTransfer = Components.PhaseTransferModels.Energy, T_U_Start = bottom.T) annotation(Placement(visible = true, transformation(origin = {25, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -270)));
    ...
    end Base_TwoPhaseExample_Var1_Energy;

    model Base_TwoPhaseExample_Var1_Evap
      extends Modelica.Icons.Example;
      import Modelica.Fluid.Sources.Boundary_pT;
      import Modelica.Media.Water.StandardWater;
      inner Modelica.Fluid.System system;
      ...
      Modelica.Blocks.Sources.Ramp ramp2(offset = 0, startTime = 500, height = 1e5, duration = 500) annotation(Placement(visible = true, transformation(origin = {-65, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow prescribedHeatFlow1 annotation(Placement(visible = true, transformation(origin = {-25, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Components.TwoPhaseVerticalPipe_Var1 P_1(D = 0.1, redeclare replaceable model PhaseTransfer = Components.PhaseTransferModels.Evaporation) annotation(Placement(visible = true, transformation(origin = {25, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -270)));
      Utilities.T_to_p_sat t_to_p_sat1 annotation(Placement(visible = true, transformation(origin = {-30, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(valveLinear1.port_a, bottom.ports[1]) annotation(Line(visible = true, origin = {25, -50}, points = {{0, 10}, {0, -10}}, color = {0, 127, 255}));
      connect(const.y, valveLinear1.opening) annotation(Line(visible = true, origin = {1.5, -30}, points = {{-15.5, 0}, {15.5, 0}}, color = {0, 0, 127}));
      ...
      connect(t_to_p_sat1.P_sat, top.p_in) annotation(Line(visible = true, origin = {14.889, 67.333}, points = {{-36.222, 2.667}, {18.111, 2.667}, {18.111, -5.333}}, color = {0, 0, 127}));
      annotation(uses(Modelica(version = "4.0.0")), Documentation, __Wolfram(ControlPanels(Panel(identifier = "charming-hardy", title = "TestPanel", elements = {InputField(variable = system.T_ambient)}))), experiment(StopTime = 3000, Interval = 0.1, Tolerance = 1e-6), Diagram(coordinateSystem(extent = {{-150, -90}, {150, 90}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Rectangle(visible = true, lineColor = {0, 114, 195}, fillColor = {255, 255, 255}, extent = {{-100, -100}, {100, 100}}, radius = 25), Text(visible = true, textColor = {64, 64, 64}, extent = {{-150, 110}, {150, 150}}, textString = "%name")}));
    end Base_TwoPhaseExample_Var1_Evap;

    model Base_TwoPhaseExample_Var1_Roshenov
      extends Modelica.Icons.Example;
      import Modelica.Fluid.Sources.Boundary_pT;
      import Modelica.Media.Water.StandardWater;
      inner Modelica.Fluid.System system;
      ...
      Modelica.Blocks.Sources.Ramp ramp2(offset = 0, startTime = 500, height = 1e5, duration = 500) annotation(Placement(visible = true, transformation(origin = {-65, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow prescribedHeatFlow1 annotation(Placement(visible = true, transformation(origin = {-25, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Components.TwoPhaseVerticalPipe_Var1 P_1(D = 0.1, redeclare replaceable model PhaseTransfer = Components.PhaseTransferModels.Roshenow) annotation(Placement(visible = true, transformation(origin = {25, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -270)));
      Utilities.T_to_p_sat t_to_p_sat1 annotation(Placement(visible = true, transformation(origin = {-30, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(valveLinear1.port_a, bottom.ports[1]) annotation(Line(visible = true, origin = {25, -50}, points = {{0, 10}, {0, -10}}, color = {0, 127, 255}));
      connect(const.y, valveLinear1.opening) annotation(Line(visible = true, origin = {1.5, -30}, points = {{-15.5, 0}, {15.5, 0}}, color = {0, 0, 127}));
      ...
      connect(t_to_p_sat1.P_sat, top.p_in) annotation(Line(visible = true, origin = {14.889, 67.333}, points = {{-36.222, 2.667}, {18.111, 2.667}, {18.111, -5.333}}, color = {0, 0, 127}));
      annotation(uses(Modelica(version = "4.0.0")), Documentation, __Wolfram(ControlPanels(Panel(identifier = "charming-hardy", title = "TestPanel", elements = {InputField(variable = system.T_ambient)}))), experiment(StopTime = 3000, Interval = 0.1, Tolerance = 1e-6), Diagram(coordinateSystem(extent = {{-150, -90}, {150, 90}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Rectangle(visible = true, lineColor = {0, 114, 195}, fillColor = {255, 255, 255}, extent = {{-100, -100}, {100, 100}}, radius = 25), Text(visible = true, textColor = {64, 64, 64}, extent = {{-150, 110}, {150, 150}}, textString = "%name")}));
    end Base_TwoPhaseExample_Var1_Roshenov;

    model Base_TwoPhaseExample_Var1_Schrage
      extends Modelica.Icons.Example;
      import Modelica.Fluid.Sources.Boundary_pT;
      import Modelica.Media.Water.StandardWater;
      inner Modelica.Fluid.System system;
      ...
      Modelica.Blocks.Sources.Ramp ramp2(offset = 0, startTime = 500, height = 1e5, duration = 500) annotation(Placement(visible = true, transformation(origin = {-65, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow prescribedHeatFlow1 annotation(Placement(visible = true, transformation(origin = {-25, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Components.TwoPhaseVerticalPipe_Var1 P_1(D = 0.1, redeclare replaceable model PhaseTransfer = Components.PhaseTransferModels.Schrage) annotation(Placement(visible = true, transformation(origin = {25, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -270)));
      Utilities.T_to_p_sat t_to_p_sat1 annotation(Placement(visible = true, transformation(origin = {-30, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(valveLinear1.port_a, bottom.ports[1]) annotation(Line(visible = true, origin = {25, -50}, points = {{0, 10}, {0, -10}}, color = {0, 127, 255}));
      connect(const.y, valveLinear1.opening) annotation(Line(visible = true, origin = {1.5, -30}, points = {{-15.5, 0}, {15.5, 0}}, color = {0, 0, 127}));
      ...
      connect(t_to_p_sat1.P_sat, top.p_in) annotation(Line(visible = true, origin = {14.889, 67.333}, points = {{-36.222, 2.667}, {18.111, 2.667}, {18.111, -5.333}}, color = {0, 0, 127}));
      annotation(uses(Modelica(version = "4.0.0")), Documentation, __Wolfram(ControlPanels(Panel(identifier = "charming-hardy", title = "TestPanel", elements = {InputField(variable = system.T_ambient)}))), experiment(StopTime = 3000, Interval = 0.1, Tolerance = 1e-6), Diagram(coordinateSystem(extent = {{-150, -90}, {150, 90}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10}), graphics = {Rectangle(visible = true, lineColor = {0, 114, 195}, fillColor = {255, 255, 255}, extent = {{-100, -100}, {100, 100}}, radius = 25), Text(visible = true, textColor = {64, 64, 64}, extent = {{-150, 110}, {150, 150}}, textString = "%name")}));
    end Base_TwoPhaseExample_Var1_Schrage;
    ...
    model Evap_Cond
      ...
      Boundary_pT bottom1(redeclare package Medium = StandardWater, p = 1.0e5, T = 293.15, nPorts = 1, use_p_in = true) annotation(Placement(visible = true, transformation(origin = {30, -20}, extent = {{-10, -10}, {10, 10}}, rotation = -270)));
    ...
    model Evap_Pipe_Cond
      ...
      Utilities.Ramp_L R_Lower_p(startTime = 10, offset = 0.1, duration = 100, height = 0.9) annotation(Placement(visible = true, transformation(origin = {110, -60}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
      Utilities.Ramp_L L_Lower_p(startTime = 10, offset = 0.1, duration = 100, height = 0.9) annotation(Placement(visible = true, transformation(origin = {-110, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Utilities.Ramp_L L_Heat(height = 1e5, duration = 1000, startTime = 500) annotation(Placement(visible = true, transformation(origin = {-110, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Utilities.Ramp_L R_Heat(height = 1e5, duration = 1000, startTime = 500) annotation(Placement(visible = true, transformation(origin = {110, 60}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
      Modelica.Fluid.Pipes.StaticPipe pipe(redeclare replaceable package Medium = StandardWater, length = 1, diameter = 0.1) annotation(Placement(visible = true, transformation(origin = {0, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(valveLinear1.port_a, bottom.ports[1]) annotation(Line(visible = true, origin = {-30, 0}, points = {{0, 10}, {0, -10}}, color = {0, 127, 255}));
      connect(const.y, valveLinear1.opening) annotation(Line(visible = true, origin = {-48.5, 20}, points = {{-10.5, 0}, {10.5, 0}}, color = {0, 0, 127}));
...
<p>A vertical pipe that sucks a medium from the lower port up to a level determined by the gravity and the density of the medium.
 ...
 Phase change can be simulated by different phase change models)</p>
    ...
    model TwoPhaseVerticalPipe_Var1 "Vertical two-phase pipe with replaceable phase transfer models"
      ...
      final SI.Mass m_l "Liquid mass (state variable)";
      final SI.Mass m_v "Vapor mass (state variable)";
      final SI.Mass m_t "Total mass";
      final SI.Velocity v(start = 0, fixed = true) "Velocity";
      //
      // Heat Port
      final Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a heatPort annotation(Placement(visible = true, transformation(origin = {0, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      final Medium.Temperature T_heatPort(start = 293.15) = heatPort.T "heatPort Temperature";
      final SI.HeatFlowRate q_F = heatPort.Q_flow "heatPort QFlow";
      //
      final SI.Pressure p_delta = port_a.p - port_b.p;
      // Energies
      final SI.Energy U(stateSelect = StateSelect.prefer);
      final SI.Temperature T_U;
      SI.Temperature T_U_Start = 293.15 "Start Temperature for init Energy";
      //
      // Instantiation of replacable model
      final PhaseTransfer phaseTransfer(p_vapor = port_b.p, q_F = heatPort.Q_flow, m_l = m_l, T_l = T_U, A_evap = A_evap, A_rosh = A_rosh) "Instantiated phase transfer model";
      //
 ...
 Phase change can be simulated by different phase change models)</p>
    ...
    package PhaseTransferModels
      ...
      partial model PartialPhaseTransfer
        ...
        // ------ SI.SpecificHeatCapacity cp_l = Medium.specificHeatCapacityCp(state_liquid);
        //
        ...
        //
        //equation
        //m_dot_phase = calculated in child;
        //q_phase  = calculated in child;
      end PartialPhaseTransfer;

      model Evaporation "Evaporation"
        String PhaseChangeModel = "Evaporation";
        extends PartialPhaseTransfer;
        parameter Real k = 10000 "Heat transfer coeff";
      equation
      ...
      model Energy "Energy-driven phase change"
        String PhaseChangeModel = "EnergyDriven";
        extends PartialPhaseTransfer;
      equation
        q_phase = 0;
        m_dot_phase = q_F / (h_v - h_l);
      end Energy;

      model NoChange "No Phase Change"
        String PhaseChangeModel = "NoChange";
        extends PartialPhaseTransfer;
      equation
        q_phase = 0;
        m_dot_phase = 0;
      ...
      model Schrage "Schrage's equation - Pressure driven"
        String PhaseChangeModel = "Schrage";
        extends PartialPhaseTransfer;
...
<div class=\"al-author-name\">&nbsp;</div>
      ...
      model Roshenow "Roshenow's boiling model Temperature driven"
        String PhaseChangeModel = "Roshenow";
        extends PartialPhaseTransfer;
        import Modelica.Constants.g_n;
